...
INSERT INTO `tbl_eventschedule` VALUES (1,'Zipline','2022-11-11','2022-11-15','11:00 AM,01:00 PM,04:00 PM',_binary '\0',1),(2,'Zipline','2022-11-11','2022-11-15','11:00 AM,01:00 PM,04:00 PM',_binary '\0',2),(3,'Zipline','2022-11-11','2022-11-15','11:00 AM,01:00 PM,04:00 PM',_binary '\0',3),(4,'zipline','2022-11-16','2022-11-18','08:50 AM,05:10 PM',_binary '\0',5),(5,'Daily','2022-11-17','2022-11-22','10:00 AM',_binary '\0',3),(6,'Evening Only','2022-11-17','2022-11-20','03:00 PM',_binary '\0',2),(7,'Special Event','2022-11-21','2022-11-29','11:10 AM,05:40 PM',_binary '\0',6),(8,'Reschedule','2022-11-21','2022-11-29','01:00 PM,07:14 AM',_binary '\0',5),(9,'Reschedule','2022-11-21','2022-11-29','08:00 AM',_binary '\0',3),(10,'Every Morning','2022-11-21','2022-11-29','09:15 AM',_binary '\0',2),(12,'New Schedule','2022-11-29','2022-12-14','10:20 AM,08:00 PM',_binary '\0',1),(13,'New Event','2022-11-29','2022-12-14','09:30 AM,07:40 PM',_binary '\0',10),(14,'Evening Event','2022-11-30','2022-12-14','05:00 PM',_binary '\0',11),(15,'Four Days only','2022-11-30','2022-12-14','03:15 PM',_binary '\0',5),(16,'Special Event','2022-11-30','2022-12-14','12:35 PM',_binary '\0',2),(17,'New Schedule','2022-11-30','2022-12-14','02:00 PM',_binary '\0',6);
...
DELIMITER ;;
CREATE PROCEDURE `Getdatesbetweentwodays`(
in DateFrom date,
in DateTo date
)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `test_SaveScheduleAndDate`(in ScheduleId int,in Name varchar(100),in DateFrom datetime,in DateTo datetime,in Times varchar(255),in EventId int,out startDate int, out endDate int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `test_SaveScheduleDates`(
in DateFrom date,
in DateTo date,
in evantId int,
in scheduleId int
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `usp_Booking_BookingById`(in id int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `usp_Booking_FetchBookingDetails`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `usp_Booking_SaveEventBooking`(
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `usp_Event_EventDetails`()
BEGIN
SELECT `EventId`,
    `EventName`,
    `EventDiscription`,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `usp_Event_EventDetailsById`(in eId int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `usp_Event_FetchEvents`()
BEGIN
SELECT sd.Date
FROM tbl_events e 
...
CAST(CAST(STR_TO_DATE(st.time, '%h:%i %p') as time) AS CHAR) AS orderbyTime, st.Time,s.Bookings ,s.Available 
FROM tbl_events e
LEFT JOIN ( 
	SELECT eb.EventId,sum(Guests) AS Bookings, e.eventcapacity - sum(Guests)  AS Available
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `usp_Event_FetchScheduleDetails`(in id int)
BEGIN
SELECT	`EventId`,
		`ScheduleId`,
		`Name`,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `usp_Event_GetAllEvents`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `usp_Event_GetEventById`(in id int )
BEGIN
SELECT e.eventId, es.ScheduleId,sd.DateId,st.SlotId, e.EventName, e.EventDiscription, e.Price, 
e.EventCapacity, e.Min_Booking, e.Max_Booking, e.EventImage, es.Name, sd.Date, cast(STR_TO_DATE(st.time, '%h:%i %p')as datetime) AS times, dayname(sd.Date) AS DayName,  DATE_FORMAT(sd.Date,'%M %d %Y') AS FullDate, s.Bookings ,s.Available 
FROM tbl_events e
LEFT JOIN ( 
	SELECT eb.EventId,sum(Guests) AS Bookings, e.eventcapacity - sum(Guests)  AS Available
    FROM `zipline`.`tbl_eventbooking` eb
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `usp_Event_SaveEvent`(
in eId int,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `usp_Event_SaveEventDates`(in singleDate datetime,in eid int,in sid int,out dateId int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `usp_Event_SaveEventSchedule`(in ScheduleId int,in Name varchar(100),in DateFrom datetime,in DateTo datetime,in Times varchar(255),in EventId int,out returnVal int)
BEGIN
		DECLARE newScheduleId int default 0;  
	IF ScheduleId = 0 THEN
			INSERT INTO tbl_eventschedule(`Name`,`DateFrom`,`DateTo`,`Times`,`EventId`)
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `usp_Event_SaveEventTimeSlot`(in ScheduleTime varchar(15),in eId int, in sId int,in dId int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `usp_Event_ScheduleById`(id int)
BEGIN
SELECT	`EventId`,
		`ScheduleId`,
		`Name`,
		...
		`DateTo`,
		`Times`
FROM `tbl_eventschedule` WHERE ScheduleId = id AND IsDeleted = 0;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `usp_User_GetUsers`()
BEGIN
...
-- Dump completed on 2022-12-01 18:25:06
