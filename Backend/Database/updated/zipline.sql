...
INSERT INTO `tbl_eventbooking` VALUES (1,3,10,22,249,347,1,20.00,'10:01 AM','2022-12-16',0,'2022-12-15 18:01:55'),(2,4,10,22,249,347,6,120.00,'03:35 PM','2022-12-16',1,'2022-12-15 18:01:55'),(4,6,10,22,249,347,1,20.00,'08:15 AM','2022-12-16',0,'2022-12-15 18:22:02'),(5,7,10,22,250,348,3,60.00,'08:15 AM','2022-12-17',0,'2022-12-17 10:37:24'),(6,8,10,22,250,348,3,60.00,'08:15 AM','2022-12-17',1,'2022-12-17 10:41:19'),(7,9,10,22,251,349,3,60.00,'08:15 AM','2022-12-18',0,'2022-12-17 11:49:06'),(8,10,6,25,321,444,6,210.00,'09:10 AM','2022-12-20',1,'2022-12-20 10:15:48'),(9,11,11,23,326,449,4,60.00,'10:30 AM','2022-12-20',1,'2022-12-20 14:28:59'),(11,13,18,31,395,549,5,300.00,'11:34 AM','2023-01-06',1,'2023-01-06 11:38:33'),(12,14,18,31,395,549,5,300.00,'11:34 AM','2023-01-06',1,'2023-01-06 12:18:36');
...
INSERT INTO `tbl_eventschedule` VALUES (1,'Zipline test','2022-11-11','2022-11-15','05:00 AM,11:19 AM,01:23 AM',_binary '\0',1),(2,'Zipline_test','2022-11-12','2022-11-16','10:00 AM,05:00 PM',_binary '\0',2),(3,'Zipline','2022-11-11','2022-11-16','11:00 AM',_binary '\0',3),(4,'zipline','2022-11-16','2022-11-18','08:50 AM,05:10 PM',_binary '\0',5),(5,'Daily','2022-11-17','2022-11-22','10:00 AM',_binary '\0',3),(6,'Evening Only','2022-11-17','2022-11-20','03:00 PM',_binary '\0',2),(7,'Special Event','2022-11-21','2022-11-29','11:10 AM,05:40 PM',_binary '\0',6),(8,'Reschedule','2022-11-21','2022-11-29','01:00 PM,07:14 AM',_binary '\0',5),(9,'Reschedule','2022-11-21','2022-11-29','08:00 AM',_binary '\0',3),(10,'Every Morning','2022-11-21','2022-11-29','09:15 AM',_binary '\0',2),(12,'New Schedule','2022-11-29','2022-12-14','10:20 AM,08:00 PM',_binary '\0',1),(13,'New Event','2022-11-29','2022-12-14','09:30 AM,07:40 PM',_binary '\0',10),(14,'Evening Event','2022-11-30','2022-12-14','05:00 PM',_binary '\0',11),(15,'Four Days only','2022-11-30','2022-12-14','03:15 PM',_binary '\0',5),(16,'Special Event','2022-11-30','2022-12-14','12:35 PM',_binary '\0',2),(17,'New Schedule','2022-11-30','2022-12-14','02:00 PM',_binary '\0',6),(19,'Special Event','2022-12-07','2022-12-14','10:00 AM',_binary '\0',14),(20,'Special Event','2022-12-15','2022-12-20','02:30 PM',_binary '\0',15),(22,'Special Event','2022-12-13','2022-12-19','08:15 AM',_binary '\0',10),(23,'Special Event','2022-12-20','2022-12-25','10:30 AM',_binary '\0',11),(24,'Stephen','2022-12-21','2022-12-25','11:25 AM',_binary '\0',1),(25,'Special Event','2022-12-19','2022-12-24','09:10 AM',_binary '\0',6),(26,'New','2022-12-26','2022-12-30','03:27 PM',_binary '\0',6),(27,'New','2022-12-26','2022-12-30','06:30 AM',_binary '\0',15),(30,'Special Event','2023-01-03','2023-01-09','12:00 AM',_binary '\0',16),(31,'Special Event','2023-01-06','2023-01-17','11:34 AM',_binary '\0',18),(32,'New event','2023-01-15','2023-01-21','02:38 AM,08:38 PM',_binary '\0',18);
...
INSERT INTO `tbl_payment` VALUES (1,'Damien Peter',4263982640269299,'2022-05',956,2),(4,'Santhana Raj Kumar',51051051051051,'2022-12',425,6),(5,'Jerin Monish',5132146546786464,'2022-10',847,8),(6,'Kirthik',4444444444444444,'2022-12',123,9),(8,'Stephan Raj',452565214548526,'2023-01',456,11),(9,'Kirthik',7897879879879799,'2023-01',151,12);
...
--
/*!50003 DROP PROCEDURE IF EXISTS `FetchEventRosterView` */;
...
DELIMITER ;;
CREATE DEFINER=`sjc`@`%` PROCEDURE `FetchEventRosterView`(in pSlotId Int)
BEGIN

		declare pDateId Int Default 0;
		declare pDate date;

	SET pDateId := (SELECT DateId FROM zipline.tbl_eventscheduletimeslots WHERE SlotId = pSlotId);
    SET pDate := (SELECT Date FROM zipline.tbl_eventscheduledates WHERE DateId = pDateId);
		...
		WHERE sd.Date >= DATE_FORMAT(pDate,'%Y-%m-%d')
		GROUP BY sd.Date
		ORDER BY sd.Date;
...
BEGIN
	SELECT eb.BookingId, e.eventName, e.price, eb.Guests, eb.TotalPrice,
    eb.EventTime, Eb.EventDate FROM `tbl_eventbooking` eb
    LEFT JOIN tbl_events e 
    on e.EventId = eb.EventId
    where eb.PaymentStatus = 0;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `usp_Booking_FetchOrderById` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`sjc`@`%` PROCEDURE `usp_Booking_FetchOrderById`(IN pBookingId INT)
BEGIN
	SELECT eb.BookingId, eb.Guests, eb.TotalPrice, e.Price, eb.EventTime,
	eb.EventDate,u.FirstName, u.LastName, u.Email, u.Phone, e.EventName,
    eb.BookingDate FROM `tbl_eventbooking` eb
		LEFT JOIN tbl_user u on u.UserId = eb.userId
		LEFT JOIN tbl_events e on e.EventId = eb.EventId
    WHERE eb.BookingId = pBookingId;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `usp_Event_FetchEventRosterView` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`sjc`@`%` PROCEDURE `usp_Event_FetchEventRosterView`(in pSlotId Int)
BEGIN
...
-- Dump completed on 2023-01-06 14:11:29
